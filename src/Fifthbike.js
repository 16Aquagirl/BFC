import hunter from "./royalenfieldhunter350.webp"
import hunter2 from "./royalenfieldhunter350-2.webp"
import hunter3 from "./royalgreyhunter.webp"
import hunter4 from "./enfieldgreen.webp"
                            ...
                            <div className="wrapper row">
                                <div className="preview col-md-6">
                                    ...
                                    <div className="preview-pic tab-content">
                                        <div className="tab-pane active" id="pic-1"><img src={hunter} /></div>
                                        <div className="tab-pane" id="pic-2"><img src={hunter} /></div>
                                        <div className="tab-pane" id="pic-3"><img src={hunter} /></div>
                                        <div className="tab-pane" id="pic-4"><img src={hunter} /></div>
                                        <div className="tab-pane" id="pic-5"><img src={hunter} /></div>
                                    </div>
                                    <ul className="preview-thumbnail nav nav-tabs">
                                        <li className="active"><a data-target="#pic-1" data-toggle="tab"><img src={hunter2} /></a></li>
                                        <li><a data-target="#pic-2" data-toggle="tab"><img src={hunter3} /></a></li>
                                        <li><a data-target="#pic-3" data-toggle="tab"><img src={hunter} /></a></li>
                                        <li><a data-target="#pic-4" data-toggle="tab"><img src={hunter4} /></a></li>
                                        <li><a data-target="#pic-4" data-toggle="tab"><img src={hunter5} /></a></li>
                                    </ul>

                                </div>
                                <div className="details col-md-6">
                                    <h3 className="product-title">Royal Enfield Hunter</h3>
                                    ...
                                    <h5 class="colors">Colors:
                                        <span className="color red not-available" data-toggle="tooltip" title="Not In store"></span>
                                    ...
                                    <div className="action">
                                        <button className="buy-now btn btn-default" type="button">Buy Now</button>
